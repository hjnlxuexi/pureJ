...
import com.lamb.framework.adapter.protocol.builder.IProtocolBuilder;
import com.lamb.framework.adapter.protocol.connector.IConnector;
import com.lamb.framework.adapter.protocol.parser.IProtocolParser;
 ...
 */
@Component("core")
public class ProtocolTool4Core implements IProtocolTool {
    /**
     * 外部服务报文组装器
     */
    @Resource
    private IProtocolBuilder builder4Core;
    /**
     * 外部服务连接器
     */
    @Resource
     ...
     */
    @Resource
    private IProtocolParser parser4Core;
    /**
     * 调用外部服务
     * @param context 数据总线
